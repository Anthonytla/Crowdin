...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Project::class, mappedBy="userId", orphanRemoval=true, fetch="EAGER")
     */
    private $projects;

    /**
     * @ORM\ManyToMany(targetEntity=Lang::class, mappedBy="users", cascade={"persist"}, fetch="EAGER")
     */
    private $langs;

 ...
 */
final class Version20210525201426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE traduction_source (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, target LONGTEXT NOT NULL, source VARCHAR(255) NOT NULL, INDEX IDX_E51D494166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
